            ...
            <div class="col-12">
                ...
                <div class="card mt-5">
                    <div class="card-body mx-5">
                        ...
                        @endforeach
                        @else
                        <p class="text-center" style="color: #768A6E;">Detail kosong.</p>
                        @endif

                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <h6 class="card-title mx-3" style="color:#768A6E;">Total Harga</h6>
                            <h6 class="card-title mx-3" style="color:#768A6E;">Rp {{ number_format($data['total_harga'], 0, ',', '.') }}</h6>
                        </div>

                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <h6 class="card-title mx-3" style="color:#768A6E;">Total Bayar</h6>
                            <h6 class="card-title mx-3" style="color:#768A6E;">Rp {{ number_format($data['total_bayar'], 0, ',', '.') }}</h6>
                        </div>
                    </div>
                </div>
            </div>
